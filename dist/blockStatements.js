...
exports.createConditionStatement = function (blockStatement, invertCondition) {
    ...
    var boolCondSubject = Babel.callExpression(Babel.identifier('Boolean'), [blockStatement.params.length == 1 ? expressions_1.resolveExpression(blockStatement.params[0]) : expressions_1.resolveStatementParametersExpression(blockStatement.params)]);
    if (invertCondition) {
